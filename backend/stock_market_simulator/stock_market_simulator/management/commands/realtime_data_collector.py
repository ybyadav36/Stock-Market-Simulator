...
from Script.realtime_data_collector import main as realtime_data_collector_main

class Command(BaseCommand):
    help = 'Collect realtime data'

    def handle(self, *args, **kwargs):
        # Call the main function of your realtime data collector script
        realtime_data_collector_main()
